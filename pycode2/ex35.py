...
def bear_room():
    ...
    #The variable needs to set as we are using it in loop
    bear_moved = False 
    ...
    while True:
        ...
        if next == "take honey":
            ...
            bear_moved = True
        #Bear already moved still taunting !! 
...
if __name__ == "__main__":
    ...
    print "Run the program as main module, or execute start()"
